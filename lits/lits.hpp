 ...
 * Last Modified Date: 2024-03-21 09:15:44 (Beijing Time)
 *
...
namespace lits {
    ...
    public:
        LITSSingleThread() = default;
        ~LITSSingleThread() = default;

        bool bulkload(const char** _keys, const uint64_t* _vals, const int _len, HPT* _hpt = NULL) {
    ...
    private:
        bool _bulkload(const str* _keys, const uint64_t* _vals, const int _len, HPT* _hpt = NULL) {
