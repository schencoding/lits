 ...
 * Last Modified Date: 2024-03-21 09:14:40 (Beijing Time)
 *
...
namespace lits {
    ...
    inline bool HOTRemove(HOTIndex& index, const str k) {
    ...
    inline void HOTBulkload(HOTIndex& index, const record& kvs, const int l, const int r) {
